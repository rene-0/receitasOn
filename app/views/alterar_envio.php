<html>
	<head>
		...
		<link rel='stylesheet' href='<?php echo App\Core\Router::getBaseUrl(); ?>css/enviar.css'>
		<link href="https://cdn.quilljs.com/1.3.6/quill.snow.css" rel="stylesheet">
		<script src="https://cdn.quilljs.com/1.3.6/quill.js"></script>
		<script src="<?php echo App\Core\Router::getBaseUrl(); ?>js/main.js"></script>
		<script src="<?php echo App\Core\Router::getBaseUrl(); ?>js/alterar_envio.js"></script>
		<title>Alterar Envio</title>
